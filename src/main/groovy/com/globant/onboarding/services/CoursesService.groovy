...
class CoursesService {
    ...
    Course findById(Long id){
        return new Course(id: id, title:'Angul1', videoUrl:'https://github.com/training-committee/onboarding', name: 'AngularJS', description: 'Angular Course', imageUrl: node_modules/bower/lib/node_modules/hawk/images/hawk.png)
    }
}
